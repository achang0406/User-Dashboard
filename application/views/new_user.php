...
<!-- put your content here -->
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="/mains/admin_dashboard"><button type="submit" class="btn btn-default pull-right">Return to Dashboard</button></a>
            </div>
            <div class="col-md-2"></div>
        </div>
        <br>
        <div class="row form">
            ...
            <div class="col-md-8">
                <form action='/user_info_process/new_user' method='post'>
                    <input type="hidden" class="form-control" name="action" value="new_user">
